...
import static com.bsuir.constant.JobServiceConstant.Validation.Message.NOT_VALID_FILED;

@RestControllerAdvice
public class JobExceptionHandler {

    @ExceptionHandler({SkillNotFoundException.class, JobNotFoundException.class, SkillForFreelancerNotFoundException.class, ResourceNotFoundException.class, ProposalNotFoundException.class,  NoHandlerFoundException.class})
